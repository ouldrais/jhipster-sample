...
public class PositionRequirement implements Serializable {
    ...
    @JsonIgnoreProperties(value = { "positionRequirement", "resourceTraining" }, allowSetters = true)
    @OneToOne(fetch = FetchType.LAZY, mappedBy = "positionRequirement")
    ...
    public void setTraining(Training training) {
        if (this.training != null) {
            this.training.setPositionRequirement(null);
        }
        if (training != null) {
            training.setPositionRequirement(this);
        }
    ...
    public void setPosition(Position position) {
        if (this.position != null) {
            this.position.setPositionRequirement(null);
        }
        if (position != null) {
            position.setPositionRequirement(this);
        }
