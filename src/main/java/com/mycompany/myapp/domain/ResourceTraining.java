...
public class ResourceTraining implements Serializable {
    ...
    @OneToOne(fetch = FetchType.LAZY, mappedBy = "resourceTraining")
    ...
    public void setResource(Resource resource) {
        if (this.resource != null) {
            this.resource.setResourceTraining(null);
        }
        if (resource != null) {
            resource.setResourceTraining(this);
        }
    ...
    public void setTraining(Training training) {
        if (this.training != null) {
            this.training.setResourceTraining(null);
        }
        if (training != null) {
            training.setResourceTraining(this);
        }
