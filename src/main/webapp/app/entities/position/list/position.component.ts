...
export class PositionComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPosition): number => this.positionService.getPositionIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.positions = this.refineData(dataFromBody);
  }

  protected refineData(data: IPosition[]): IPosition[] {
