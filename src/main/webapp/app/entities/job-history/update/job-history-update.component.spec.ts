...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 18519 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 5383 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 30652 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 5347 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 8617 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 20107 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 28488 };
      jobHistory.job = job;
      const department: IDepartment = { id: 19744 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 25922 };
      jobHistory.employee = employee;
