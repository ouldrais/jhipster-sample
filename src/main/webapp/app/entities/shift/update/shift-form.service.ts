...
type ShiftFormGroupContent = {
  ...
  teamPlan: FormControl<ShiftFormRawValue['teamPlan']>;
  shiftDemand: FormControl<ShiftFormRawValue['shiftDemand']>;
  resourcePlan: FormControl<ShiftFormRawValue['resourcePlan']>;
};
...
export class ShiftFormService {
  createShiftFormGroup(shift: ShiftFormGroupInput = { id: null }): ShiftFormGroup {
    ...
    return new FormGroup<ShiftFormGroupContent>({
      ...
      teamPlan: new FormControl(shiftRawValue.teamPlan),
      shiftDemand: new FormControl(shiftRawValue.shiftDemand),
      resourcePlan: new FormControl(shiftRawValue.resourcePlan),
    });
  }
