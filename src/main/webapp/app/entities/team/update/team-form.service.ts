...
type TeamFormGroupContent = {
  ...
  resource: FormControl<ITeam['resource']>;
  teamPlan: FormControl<ITeam['teamPlan']>;
};
...
export class TeamFormService {
  createTeamFormGroup(team: TeamFormGroupInput = { id: null }): TeamFormGroup {
    ...
    return new FormGroup<TeamFormGroupContent>({
      ...
      resource: new FormControl(teamRawValue.resource),
      teamPlan: new FormControl(teamRawValue.teamPlan),
    });
  }
